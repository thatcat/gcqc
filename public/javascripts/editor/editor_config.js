...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fontfamily","fontsize","bold","italic","underline","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","link","unlink","emotion","insertimage","insertvideo","attachment","separate","horizontal","map","spechars","autotypeset","paragraph","rowspacingbottom","rowspacingtop","lineheight","imagenone","imageleft","imageright","imagecenter"]]
